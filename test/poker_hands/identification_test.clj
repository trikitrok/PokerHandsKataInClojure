(ns poker-hands.identification-test
  (:use midje.sweet)
  (:require [poker-hands.identification :refer [identify]])
...
(facts
  ...
  (fact
    ...
    (identify examples/pair-card-with-2S-8D-5C-QS-2D) => {:type  :pair
                                                          :cards examples/pair-card-with-2S-8D-5C-QS-2D})

  (fact
    "can identify a Two Pairs hand"
    (identify examples/two-pair-with-2S-5D-5C-QS-2D) => {:type  :two-pairs
                                                          :cards examples/two-pair-with-2S-5D-5C-QS-2D})

  (fact
    "can identify a Three of a Kind hand"
    (identify examples/triplet-with-5S-5D-5C-QS-2D) => {:type :triplet
                                                        :cards examples/triplet-with-5S-5D-5C-QS-2D})

  (fact
    "can identify a Straight hand"
    (identify examples/straight-with-QS-JD-10H-9S-8C) => {:type :straight
                                                          :cards examples/straight-with-QS-JD-10H-9S-8C}
    (identify examples/straight-with-AS-KC-QH-JH-10D) => {:type :straight
                                                          :cards examples/straight-with-AS-KC-QH-JH-10D}
    (identify examples/straight-wheel-5C-4H-3D-2C-AS) => {:type :straight
                                                          :cards examples/straight-wheel-5C-4H-3D-2C-AS})

  (fact
    "can identify a Straight Flush hand"
    (identify examples/straight-flush-with-QS-JS-10S-9S-8S) => {:type :straight-flush
                                                                :cards examples/straight-flush-with-QS-JS-10S-9S-8S})

  (fact
    "can identify a Full House hand"
    (identify examples/full-house-with-5S-2S-5D-2D-5C) => {:type :full-house
                                                           :cards examples/full-house-with-5S-2S-5D-2D-5C})

  (fact
    "can identify a Four of a Kind hand"
    (identify examples/four-of-kind-with-5S-5D-5C-QS-5H) => {:type :four-kind
